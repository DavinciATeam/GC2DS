...
import gc2.ds.ligand.IntentionLigand;
...
public class IntentionBCell extends BCell {

	private static final long serialVersionUID = 1L;

	public IntentionBCell(Anima anima) {
		super(anima);
	}
	...
	public IPlan selectPlan() {
		ILigand ligand = (ILigand) this.anima.getBDI().getBelief(DSTerm.DesireLigand);
		return FeedbackPlanFactory.getInstance().generateFeedbackPlan(anima, new Feedback(ligand, new IntentionLigand()));
	}
