...
import gc2.intent.book_movie.plan.BookMovieAskBackPlan;
...
public class BookMovieAskBackMCell extends MCell {

	private static final long serialVersionUID = 1L;

	public BookMovieAskBackMCell(Anima anima) {
		super(anima);
	}
	...
	public IPlan selectPlan() {
		...
		return new BookMovieAskBackPlan(anima, ligand);
