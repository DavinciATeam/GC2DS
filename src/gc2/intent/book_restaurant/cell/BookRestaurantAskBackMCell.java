package gc2.intent.book_restaurant.cell;

import gc2.intent.book_restaurant.plan.BookRestaurantAskBackPlan;
...
public class BookRestaurantAskBackMCell extends MCell {

	private static final long serialVersionUID = 1L;

	public BookRestaurantAskBackMCell(Anima anima) {
		super(anima);
	}
	...
	public boolean isTrigger() throws Exception {
		...
		if(ligand!=null){
			...
			if(intent.equals(NLPTerm.IntentBookRestaurant)){
				return true;
			}
		}
		return false;
	...
	public IPlan selectPlan() {
		...
		return new BookRestaurantAskBackPlan(anima, ligand);
	}
}
