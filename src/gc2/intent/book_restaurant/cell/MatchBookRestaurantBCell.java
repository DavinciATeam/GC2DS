...
import gc2.intent.book_restaurant.plan.MatchBookRestaurantPlan;
...
public class MatchBookRestaurantBCell extends BCell {

	private static final long serialVersionUID = 1L;

	public MatchBookRestaurantBCell(Anima anima) {
		super(anima);
	}
	...
	public IPlan selectPlan() {
		ILigand ligand = (ILigand) anima.getBDI().getBelief(IntentTerm.ExtractLigand);
		return new MatchBookRestaurantPlan(anima, ligand);
