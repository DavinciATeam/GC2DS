...
import gc2.intent.book_tr.module.model.TRPrice;
import gc2.intent.book_tr.module.model.TRSchedule;
...
public class BookTRAskBackPlan extends AExecutionPlan {

	public BookTRAskBackPlan(IAnima anima, ILigand ligand) {
		super(anima, ligand);
	}
