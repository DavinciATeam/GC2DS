...
import gc2.intent.buy_ti.plan.BuyTIAskBackPlan;
...
public class BuyTIAskBackMCell extends MCell {

	private static final long serialVersionUID = 1L;

	public BuyTIAskBackMCell(Anima anima) {
		super(anima);
	}
	...
	public IPlan selectPlan() {
		...
		return new BuyTIAskBackPlan(anima, ligand);
	}
