...
import gc2.intent.common.plan.ExtractAgeTicketTypePlan;
...
public class ExtractAgeTicketTypeBCell extends BCell {

	private static final long serialVersionUID = 1L;

	public ExtractAgeTicketTypeBCell(Anima anima) {
		super(anima);
	}
	...
	public boolean isTrigger() throws Exception {
		...
		if(ligand!=null){
			...
			for(Sentence sentence: sentences){
				...
				if(text.contains("全票")||text.contains("優待")){
					return true;
				}
			}
		}
	...
	public IPlan selectPlan() {
		ILigand ligand = (ILigand) anima.getBDI().getBelief(IntentTerm.IntentLigand);
		return new ExtractAgeTicketTypePlan(anima, ligand);
	}
