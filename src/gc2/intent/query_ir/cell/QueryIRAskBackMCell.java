...
import gc2.intent.query_ir.plan.QueryIRAskBackPlan;
...
public class QueryIRAskBackMCell extends MCell {

    private static final long serialVersionUID = 1L;

    public QueryIRAskBackMCell(Anima anima) {
        super(anima);
    }
    ...
    public IPlan selectPlan() {
        ...
        return new QueryIRAskBackPlan(anima, ligand);
    }
}
