...
public class MatchRecommendRestaurantBCell extends BCell {

	private static final long serialVersionUID = 1L;

	public MatchRecommendRestaurantBCell(Anima anima) {
		super(anima);
	}
	...
	public IPlan selectPlan() {
		...
		return new MatchRecommendRestaurantPlan(anima, ligand);
	}
}
