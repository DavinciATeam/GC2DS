package gc2.intent.recommend_ta.cell;
...
import gc2.intent.recommend_ta.plan.RecommendTAAskBackPlan;
...
public class RecommendTAAskBackMCell extends MCell {

	private static final long serialVersionUID = 1L;

	public RecommendTAAskBackMCell(Anima anima) {
		super(anima);
	}
	...
	public boolean isTrigger() throws Exception {
		...
		if(ligand!=null){
			...
			if(intent.equals(NLPTerm.IntentRecommendTA)){
				return true;
			}
		}
		return false;
	...
	public IPlan selectPlan() {
		...
		return new RecommendTAAskBackPlan(anima, ligand);
	}
}
