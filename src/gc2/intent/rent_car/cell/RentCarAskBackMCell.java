...
import gc2.intent.rent_car.plan.RentCarAskBackPlan;
...
public class RentCarAskBackMCell extends MCell {

    private static final long serialVersionUID = 1L;

    public RentCarAskBackMCell(Anima anima) {
        super(anima);
    }
    ...
    public IPlan selectPlan() {
        ...
        return new RentCarAskBackPlan(anima, ligand);
    }
}
