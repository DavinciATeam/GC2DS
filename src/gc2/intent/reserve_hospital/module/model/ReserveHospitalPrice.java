...
public class ReserveHospitalPrice {
	...
	//Singleton
	private ReserveHospitalPrice(){}
	private static ReserveHospitalPrice hsrPrice = new ReserveHospitalPrice();
	public static ReserveHospitalPrice getInstance(){
		if(hsrPrice==null){
			hsrPrice = new ReserveHospitalPrice();
		}
		return hsrPrice;
	}
